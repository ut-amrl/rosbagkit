...
Bbox3D = Tuple[float, float, float, float, float, float, float, float, float]
BboxEdges3D = Tuple[
    Tuple[int, int],
    Tuple[int, int],
    Tuple[int, int],
...
Bbox2D = Tuple[Optional[int], Optional[int], Optional[int], Optional[int]]


def get_corners_3d_bbox(
    cX: float,
    cY: float,
    cZ: float,
    l: float,
    ...
    Args:
        cX, cY, cZ: center of the bounding box (in meters)
        l, w, h: length, width, height of the bounding box (in meters)
        roll, pitch, yaw: rotation angles of the bounding box (in radians)
